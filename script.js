...
const i18n = {
    pt: {
        ...
        'sobre-p2'           : 'Atualmente baseado em Porto, Portugal, vem expandindo sua presença com uma proposta focada em groove, energia e construção de sets dinâmicos. Seu som transita entre Tech House e Minimal Deep Tech, sempre com influência direta da pista e da estética europeia.',
        'sobre-p3'           : 'Sua identidade combina o moderno com referências retrô, criando uma experiência sonora e visual que conecta passado e futuro.',
        ...
        'booking-email-btn'  : 'E-mail',
        'booking-email-aria' : 'Enviar e-mail para Luan.terroso020@gmail.com',
    ...
    en: {
        ...
        'sobre-p2'           : 'Now based in Porto, Portugal, he is expanding his presence with a focus on groove, energy, and dynamic sets. His sound moves between Tech House and Minimal Deep Tech, always with direct influence from the floor and European aesthetics.',
        'sobre-p3'           : 'His identity blends the modern with retro references, creating a sonic and visual experience that connects past and future.',
        ...
        'booking-email-btn'  : 'Email',
        'booking-email-aria' : 'Send email to Luan.terroso020@gmail.com',
    ...
    es: {
        ...
        'sobre-p2'           : 'Actualmente con base en Porto, Portugal, amplía su presencia con una propuesta centrada en groove, energía y sets dinámicos. Su sonido transita entre Tech House y Minimal Deep Tech, siempre con influencia directa de la pista y la estética europea.',
        'sobre-p3'           : 'Su identidad combina lo moderno con referencias retro, creando una experiencia sonora y visual que conecta pasado y futuro.',
        ...
        'booking-email-btn'  : 'Correo',
        'booking-email-aria' : 'Enviar correo a Luan.terroso020@gmail.com',
        'available-private'  : 'Eventos Privados',
    ...
    zh: {
        ...
        'sobre-p2'           : '现居葡萄牙波尔图，正以律动、能量与动态 set 为轴展开事业。声音在 Tech House 与 Minimal Deep Tech 之间游走，始终受舞池与欧洲美学直接影响。',
        'sobre-p3'           : '身份将现代感与复古参照融合，塑造连接过去与未来的声音与视觉体验。',
        ...
        'booking-email-btn'  : '邮箱',
        'booking-email-aria' : '发送邮件至 Luan.terroso020@gmail.com',
    ...
    de: {
        ...
        'sobre-p2'           : 'Heute mit Basis in Porto, Portugal, erweitert er seine Präsenz mit Fokus auf Groove, Energie und dynamische Sets. Sein Sound bewegt sich zwischen Tech House und Minimal Deep Tech, stets mit direktem Einfluss vom Floor und der europäischen Ästhetik.',
        'sobre-p3'           : 'Seine Identität verbindet Modernes mit Retro-Referenzen und schafft ein klangliches und visuelles Erlebnis, das Vergangenheit und Zukunft verbindet.',
        ...
        'booking-email-btn'  : 'E-Mail',
        'booking-email-aria' : 'E-Mail an Luan.terroso020@gmail.com senden',
        'available-private'  : 'Private Events',
    ...
    ja: {
        ...
        'sobre-p2'           : 'いまはポルトガルのポルトを拠点に、グルーヴ、エネルギー、ダイナミックなセットを軸に存在感を広げています。サウンドは Tech House と Minimal Deep Tech のあいだを行き来し、フロアとヨーロッパの美学の影響を直接受けています。',
        'sobre-p3'           : 'アイデンティティはモダンさとレトロな参照を組み合わせ、過去と未来をつなぐサウンドとビジュアルの体験を生み出します。',
        ...
        'booking-email-btn'  : 'メール',
        'booking-email-aria' : 'Luan.terroso020@gmail.com にメールを送る',
