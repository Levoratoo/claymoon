...
const i18n = {
    pt: {
        ...
        'ch01-desc'          : 'Brasil, Maringá: música, palco e instrumento desde cedo — em 2011, o primeiro passo sério. A formação em Música pela UEM deu base; o pagode deu estrada e conexão com o público. Anos depois, a mesma energia encontrou a eletrônica: Dublin, a cena europeia, e hoje Porto como base com ClayMoon.music — Tech House e Minimal Deep Tech no booth.',
    ...
    en: {
        ...
        'ch01-desc'          : 'Brazil, Maringá: music, stage, and instruments from an early age — in 2011, the first real step. A Music degree at UEM gave foundation; pagode gave the road and a bond with the crowd. Years later, that same drive found electronic music: Dublin, the European scene, and today Porto as home with ClayMoon.music — Tech House and Minimal Deep Tech behind the decks.',
        'ch02-tag'           : 'CHAPTER 02',
    ...
    es: {
        ...
        'ch01-desc'          : 'Brasil, Maringá: música, escenario e instrumento desde joven — en 2011, el primer paso en serio. La carrera en Música en la UEM dio base; el pagode dio carretera y conexión con el público. Años después, la misma energía encontró la electrónica: Dublín, la escena europea, y hoy Oporto como base con ClayMoon.music — Tech House y Minimal Deep Tech en cabina.',
        'ch02-tag'           : 'CAPÍTULO 02',
    ...
    zh: {
        ...
        'ch01-desc'          : '巴西，马林加：从小与音乐、舞台和乐器相伴——2011年迈出认真的一步。在马林加州立大学（UEM）的音乐专业打下根基；pagode 带来巡演与和观众的连结。多年后，同样的能量投入电子音乐：都柏林、欧洲场景，如今以波尔图为基地，以 ClayMoon.music 呈现 Tech House 与 Minimal Deep Tech。',
        'ch02-tag'           : '第二章',
    ...
    de: {
        ...
        'ch01-desc'          : 'Brasilien, Maringá: Musik, Bühne und Instrumente von früh an — 2011 der erste echte Schritt. Das Musikstudium an der UEM gab Fundament; Pagode gab Tournee und Bindung zum Publikum. Jahre später fand dieselbe Energie die elektronische Musik: Dublin, die europäische Szene, heute Porto als Basis mit ClayMoon.music — Tech House und Minimal Deep Tech am Deck.',
        'ch02-tag'           : 'KAPITEL 02',
    ...
    ja: {
        ...
        'ch01-desc'          : 'ブラジル、マリンガ：幼い頃から音楽、ステージ、楽器——2011年、本気の一歩。UEMでの音楽の学びが土台、パゴージがツアーと観客とのつながりをくれた。年月を経て同じエネルギーがエレクトロニックへ：ダブリン、ヨーロッパのシーン、いまはポルトを拠点に ClayMoon.music で Tech House と Minimal Deep Tech を。',
        'ch02-tag'           : 'チャプター 02',
